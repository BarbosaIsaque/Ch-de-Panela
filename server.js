...
const ITEMS = [
  ...
  {id:19, cat:'Cozinha', name:'Biscoito perfeito', desc:'Contém 1 assadeira retangular de biscoito antiaderente de 38 × 26 × 2 cm e 1 assadeira retangular de biscoito antiaderente de 43 × 28 × 2 cm. Pra Ana Clara assar aquela leva de biscoitos que some da lata antes mesmo de esfriar.', price:89.9, emoji:'🍪'},
  {id:20, cat:'Cozinha', name:'Muffins dos Deuses', desc:'Contém 1 forma de cupcake de 12 cavidades e 1 forma de mini cupcake de 24 cavidades. Trinta e seis muffins de uma vez: um pro café, um pra sobremesa e o resto pra dividir com quem merece.', price:79.9, emoji:'🧁'},
  {id:21, cat:'Cozinha', name:'Vai um empadão?', desc:'Contém 1 assadeira retangular de 44,5 × 30,5 × 5,4 cm e 1 forma de bolo retangular de 22 × 27 × 5 cm. Pro empadão de domingo, a lasanha da família e tudo que pede aquele tamanho família.', price:79.9, emoji:'🥧'},
  {id:22, cat:'Cozinha', name:'Bolos de fim de tarde', desc:'Contém 2 assadeiras redondas de 26 × 4 cm. Pro bolo simples que acompanha o cafezinho das cinco — a melhor desculpa pra parar tudo e relaxar.', price:69.9, emoji:'🍰'},
  {id:23, cat:'Cozinha', name:'Um lanche diferente', desc:'Contém 1 forma de pizza antiaderente de 36 cm e 1 forma de pão de 30 × 15 × 6 cm. Pizza caseira na sexta e pão fresquinho no fim de semana — a casa vira a padaria preferida do casal.', price:59.9, emoji:'🍕'},
  {id:24, cat:'Cozinha', name:'Fada confeiteira', desc:'Contém 1 forma de pudim de 22 × 9 cm, kit de 3 formas de fundo falso de 15 × 5 cm e 1 forma de quiché redonda de 24 cm com fundo removível. Pra Ana Clara soltar a fada confeiteira que mora nela e arrasar nas tortas, quiches e pudins.', price:79.9, emoji:'🧚'},
  ...
  {id:55, cat:'Mesa', name:'Bowls m&m\'s', desc:'Conjunto de bowls divertidos do m&m\'s. Pra deixar a mesa com personalidade e servir petisco com aquele toque de bom humor.', price:89.9, emoji:'🥣'},
