...
const ITEMS = [
  // CAMA
  {id:65, name:'Cobre leito (rosa)',                        desc:'Cobre leito na cor rosa',                              cat:'Cama', price:110, emoji:'🛏️'},
  {id:75, name:'Jogo de lençol queen branco #1',            desc:'Jogo de lençol queen na cor branca',                  cat:'Cama', price:100, emoji:'🛏️'},
  {id:76, name:'Jogo de lençol queen branco #2',            desc:'Jogo de lençol queen na cor branca',                  cat:'Cama', price:100, emoji:'🛏️'},
  {id:77, name:'Jogo de lençol queen bege #1',              desc:'Jogo de lençol queen na cor bege',                    cat:'Cama', price:100, emoji:'🛏️'},
  {id:78, name:'Jogo de lençol queen bege #2',              desc:'Jogo de lençol queen na cor bege',                    cat:'Cama', price:100, emoji:'🛏️'},
  {id:79, name:'Kit cama posta (azul)',                     desc:'Kit completo cama posta na cor azul',                  cat:'Cama', price:150, emoji:'🛌'},
  {id:80, name:'Kit cama posta (verde)',                    desc:'Kit completo cama posta na cor verde',                 cat:'Cama', price:150, emoji:'🛌'},
  // MESA
  {id:31, name:'Kit barman',                               desc:'Abridor de vinho elétrico + kit drinks + cortador de pizza', cat:'Mesa', price:130, emoji:'🍸'},
  {id:35, name:'Copos do cotidiano',                       desc:'6 Copos Serena + 6 taças chopp 385ml',                  cat:'Mesa', price:80,  emoji:'🥛'},
  {id:36, name:'Kit café e chá',                           desc:'Caixa de chá + jarra medidora',                         cat:'Mesa', price:80,  emoji:'☕'},
  {id:52, name:'6 taças de vinho branco 520ml',            desc:'6 taças para vinho branco 520ml',                       cat:'Mesa', price:80,  emoji:'🍾'},
  {id:53, name:'6 taças de vinho tinto 460ml',             desc:'6 taças para vinho tinto 460ml',                        cat:'Mesa', price:50,  emoji:'🍷'},
  {id:54, name:'6 taças de gin 600ml',                     desc:'6 taças para gin 600ml',                                cat:'Mesa', price:50,  emoji:'🍹'},
  {id:55, name:'6 taças de champanhe 210ml',               desc:'6 taças para champanhe 210ml',                          cat:'Mesa', price:110, emoji:'🥂'},
  {id:58, name:'Bandeja para frios com tampa',             desc:'Bandeja para servir frios com tampa',                    cat:'Mesa', price:50,  emoji:'🧀'},
  {id:66, name:'6 taças bubble 300ml',                     desc:'6 taças bubble 300ml',                                  cat:'Mesa', price:130, emoji:'🫧'},
  {id:67, name:'Aparelho de jantar opção 1 — pratos e bowl',desc:'24 peças: pratos e bowls',                            cat:'Mesa', price:130, emoji:'🍽️'},
  {id:68, name:'Aparelho de jantar opção 1 — pires e xícaras',desc:'24 peças: pires e xícaras',                        cat:'Mesa', price:130, emoji:'🍽️'},
  {id:69, name:'Aparelho de jantar opção 2 — conjunto mesa',desc:'24 peças: conjunto mesa',                             cat:'Mesa', price:130, emoji:'🍽️'},
  {id:70, name:'Aparelho de jantar opção 2 — conjunto chá', desc:'24 peças: conjunto chá',                             cat:'Mesa', price:130, emoji:'🍽️'},
  // COZINHA
  {id:32, name:'Kit temperos e organização',               desc:'Moedor + ralador + óleo + 12 potes de tempero + funis', cat:'Cozinha', price:100, emoji:'🧂'},
  {id:33, name:'Kit acessórios de cozinha',                desc:'6 pegadores + abridor de latas + plaina',               cat:'Cozinha', price:50,  emoji:'🍳'},
  {id:34, name:'Kit frigideira + escorredor',              desc:'Frigideira 28cm + escorredor 4 peças',                  cat:'Cozinha', price:80,  emoji:'🥘'},
  {id:37, name:'Formas forneaveis — conjunto 1',           desc:'3 formas forneaveis',                                   cat:'Cozinha', price:80,  emoji:'🫕'},
  {id:38, name:'Formas forneaveis — conjunto 2',           desc:'3 formas forneaveis',                                   cat:'Cozinha', price:80,  emoji:'🫕'},
  {id:39, name:'Formas forneaveis — conjunto 3',           desc:'3 formas forneaveis',                                   cat:'Cozinha', price:80,  emoji:'🫕'},
  {id:40, name:'Formas forneaveis — conjunto 4',           desc:'3 formas forneaveis',                                   cat:'Cozinha', price:80,  emoji:'🫕'},
  {id:41, name:'Formas forneaveis — conjunto 5',           desc:'3 formas forneaveis',                                   cat:'Cozinha', price:80,  emoji:'🫕'},
  {id:42, name:'Formas forneaveis — conjunto 6',           desc:'3 formas forneaveis',                                   cat:'Cozinha', price:80,  emoji:'🫕'},
  {id:51, name:'Kit de churrasco',                         desc:'Utensílios completos para churrasco',                   cat:'Cozinha', price:50,  emoji:'🥩'},
  {id:56, name:'6 assadeiras de vidro',                    desc:'6 assadeiras de vidro refratário',                      cat:'Cozinha', price:130, emoji:'🥘'},
  {id:57, name:'3 bowls de inox',                          desc:'3 bowls de aço inox',                                   cat:'Cozinha', price:50,  emoji:'🥣'},
  {id:59, name:'4 facas de cerâmica + descascador',        desc:'4 facas de cerâmica + descascador',                     cat:'Cozinha', price:100, emoji:'🔪'},
  {id:60, name:'Kit utensílios cozinha',                   desc:'Kit completo de utensílios + tesoura + faca',           cat:'Cozinha', price:80,  emoji:'🥄'},
  {id:62, name:'Liquidificador',                           desc:'Liquidificador',                                        cat:'Cozinha', price:180, emoji:'🥤'},
  {id:63, name:'Batedeira',                                desc:'Batedeira',                                             cat:'Cozinha', price:100, emoji:'🎂'},
  {id:64, name:'Mixer',                                    desc:'Mixer',                                                 cat:'Cozinha', price:180, emoji:'🥄'},
  {id:71, name:'Jogo de panelas Tramontina Brava',         desc:'4 panelas Tramontina Brava',                            cat:'Cozinha', price:130, emoji:'🥘'},
  {id:72, name:'Panela elétrica',                          desc:'Panela elétrica',                                       cat:'Cozinha', price:130, emoji:'⚡'},
  {id:73, name:'Multiprocessador',                         desc:'Multiprocessador',                                      cat:'Cozinha', price:130, emoji:'⚙️'},
  {id:74, name:'Air Fryer',                                desc:'Air Fryer',                                             cat:'Cozinha', price:130, emoji:'🌬️'},
  // ORGANIZAÇÃO
  {id:43, name:'Potes herméticos mantimentos — conjunto A',desc:'5 potes herméticos para mantimentos',                   cat:'Organização', price:80, emoji:'🫙'},
  {id:44, name:'Potes herméticos mantimentos — conjunto B',desc:'5 potes herméticos para mantimentos',                   cat:'Organização', price:80, emoji:'🫙'},
  {id:45, name:'Potes herméticos 1040ml — conjunto A',     desc:'3 potes herméticos 1040ml',                             cat:'Organização', price:50, emoji:'🫙'},
  {id:46, name:'Potes herméticos 1040ml — conjunto B',     desc:'3 potes herméticos 1040ml',                             cat:'Organização', price:50, emoji:'🫙'},
  {id:47, name:'Potes herméticos 370ml — conjunto A',      desc:'5 potes herméticos 370ml',                              cat:'Organização', price:50, emoji:'🫙'},
  {id:48, name:'Potes herméticos 370ml — conjunto B',      desc:'5 potes herméticos 370ml',                              cat:'Organização', price:50, emoji:'🫙'},
  {id:49, name:'Potes herméticos 640ml — conjunto A',      desc:'5 potes herméticos 640ml',                              cat:'Organização', price:50, emoji:'🫙'},
  {id:50, name:'Potes herméticos 640ml — conjunto B',      desc:'5 potes herméticos 640ml',                              cat:'Organização', price:50, emoji:'🫙'},
  {id:61, name:'3 kits lavanderia',                        desc:'3 kits completos de lavanderia',                        cat:'Organização', price:50, emoji:'🧺'},
];
